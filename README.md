...
- [x] **Learn about sub-queries**: [Youtube Video](https://www.youtube.com/watch?v=GpC0XyiJPEo)  
  ...
  - ```
    ...
    FROM ...
    ```
- [x] **Learn about Common Table Expressions (CTEs)**: [Youtube Video](https://www.youtube.com/watch?v=_SanZ41uTlw)/[SQL WITH Clause | CTEs vs Subqueries vs Temp Tables](https://www.youtube.com/watch?v=LJC8277LONg)
